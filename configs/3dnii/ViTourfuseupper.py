...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels_all=[768, 768, 768, 768],
        out_channels_all=[768, 768, 768, 768],
    ),
...
work_dir = '/home/zrs/PycharmProjects/point/work_dirs/ViTourfuseupper'
...
load_from = None
resume = False
#load_from = '/home/zrs/PycharmProjects/keypoint/work_dirs/ViTourfuseupper/iter_10000.pth'
