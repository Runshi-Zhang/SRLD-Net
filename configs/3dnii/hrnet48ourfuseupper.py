...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels_all=[384,192,96,48],
        out_channels_all=[384,192,96,48],
    ),
...
work_dir = '/home/zrs/PycharmProjects/point/work_dirs/hrnet48ourfuseupper'
...
load_from = None
resume = False
#load_from = '/home/zrs/PycharmProjects/keypoint/work_dirs/hrnet48ourfuseupper/iter_10000.pth'
