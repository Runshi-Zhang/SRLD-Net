...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=[
            dict(type='PointMSELoss', loss_name='loss_point', loss_weight=1.0)
        ],
        in_channels_all=[1024, 512, 256, 128],
        out_channels_all=[1024, 512, 256, 128],
    ),
...
data_root = '/home/zrs/PycharmProjects/keypoint/configs/3dnii/cran/'
train_pipeline = [
...
work_dir = '/home/zrs/PycharmProjects/keypoint/work_dirs/conourupper'
...
val_evaluator = dict(type='PointMetric', iou_metrics=['mDice'],collect_device='gpu')
...
load_from = None
resume = False
load_from = '/home/zrs/PycharmProjects/keypoint/work_dirs/conourfuseupper/iter_10000.pth'
